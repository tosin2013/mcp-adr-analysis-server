...
| _(AI execution status — removed, dies with AI layer)_ | ~~Check AI execution mode~~   | 100-300 | –   | –      | Removed (ADR-023)                     |
...
| **Dies with the AI layer**         | 1 (AI execution status checker)                                                                                                                                             | Goes with ADR-021 migration Batch 7 / retirement                                                                                                                                                |
