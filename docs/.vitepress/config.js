...
export default withMermaid(
  defineConfig({
    ...
    ignoreDeadLinks: [
      ...
      // Research placeholder files
      /perform_research_research_\d+/,
      // Development URLs
      /localhost/,
      // Old file references
      /\/setup-website\.sh/,
        ...
        '/': [
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: 'Bootstrap Architecture Docs',
                link: '/how-to-guides/bootstrap-architecture-docs',
              },
              { text: 'Deploy Your Own Server', link: '/how-to-guides/deploy-your-own-server' },
              {
                text: 'APE Framework Implementation',
                link: '/how-to-guides/ape-implementation-strategy',
              },
              { text: 'APE Usage Guide', link: '/how-to-guides/ape-usage-guide' },
              {
                text: 'Reflexion Implementation',
                link: '/how-to-guides/reflexion-implementation-strategy',
              },
              { text: 'Reflexion Usage Guide', link: '/how-to-guides/reflexion-usage-guide' },
              {
                text: 'Knowledge Generation Usage',
                link: '/how-to-guides/knowledge-generation-usage-guide',
              },
              {
                text: 'Workflow Guidance',
                link: '/how-to-guides/getting-started-workflow-guidance',
              },
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: 'Reflexion Framework Design',
                link: '/explanation/reflexion-framework-design',
              },
              {
                text: 'Knowledge Generation Framework',
                link: '/explanation/knowledge-generation-framework-design',
              },
            ],
          },
          {
            ...
            items: [
              ...
              { text: 'Universal Workflows', link: '/ide-rules/universal-workflows' },
              {
                ...
                link: '/ide-rules/environment-validation-workflow',
              },
              ...
              { text: 'Standalone Usage', link: '/ide-rules/standalone-usage' },
              {
                ...
                items: [
                  ...
                  {
                    text: 'JetBrains',
                    link: '/ide-rules/ide-specific/jetbrains/jetbrains-rules-template',
                  },
                  {
                    text: 'Windsurf',
                    link: '/ide-rules/ide-specific/windsurf/windsurf-rules-template',
                  },
                ],
              },
            ],
