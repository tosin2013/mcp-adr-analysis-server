...
describe('rule-generation-tool', () => {
  ...
  describe('generateRules', () => {
    ...
    it('should handle invalid source type', async () => {
      await expect(generateRules({ source: 'invalid' as any }))
        .rejects
        .toThrow('Unknown rule generation source: invalid');
    });
  ...
  describe('validateRules', () => {
    ...
    it('should handle missing file path and content', async () => {
      await expect(validateRules({ rules: mockRules }))
        .rejects
        .toThrow('Either filePath or fileContent must be provided');
    });
    ...
    it('should handle missing rules', async () => {
      await expect(validateRules({ 
        ...
        .rejects
        .toThrow('Rules array is required and cannot be empty');
    });
  });
  ...
  describe('createRuleSet', () => {
    ...
    it('should handle missing rules', async () => {
      await expect(createRuleSet({ outputFormat: 'json' }))
        .rejects
