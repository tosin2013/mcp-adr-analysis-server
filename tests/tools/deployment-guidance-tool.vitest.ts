 ...
 *
 * VITEST VERSION - Migrated from Jest
...
// Normal imports work after vi.mock (hoisting works properly)
...
const mockDiscoverAdrs = discoverAdrsInDirectory as MockedFunction<typeof discoverAdrsInDirectory>;
  ...
  describe('generateDeploymentGuidance', () => {
    ...
    describe('basic functionality', () => {
      it('should generate deployment guidance with default parameters', async () => {
        ...
        expect(mockDiscoverAdrs).toHaveBeenCalledWith('docs/adrs', process.cwd(), {
          includeContent: true,
      ...
      it('should handle custom ADR directory and project path', async () => {
        ...
        expect(mockDiscoverAdrs).toHaveBeenCalledWith('custom/adrs', '/custom/project', {
          includeContent: true,
          includeTimeline: false,
        });
    ...
    describe('error handling', () => {
      it('should throw McpAdrError when ADR discovery fails', async () => {
        ...
        mockDiscoverAdrs.mockRejectedValue(discoveryError);
      ...
      it('should handle non-Error exceptions', async () => {
        mockDiscoverAdrs.mockRejectedValue('String error');
      ...
      it('should handle undefined error', async () => {
        mockDiscoverAdrs.mockRejectedValue(undefined);
