...
import { dispatchTool } from './tools/tool-dispatch.js';
import {
...
export class McpAdrAnalysisServer {
  ...
  private setupHandlers(): void {
    ...
    this.server.setRequestHandler(ListToolsRequestSchema, async () => {
      return getToolListForMCP({ mode: 'full' });
    });
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async request => {
      ...
      try {
        ...
        const response = await dispatchTool(this, name, safeArgs, context);
...
`,
  ...
  async getDevelopmentGuidance(args: GetDevelopmentGuidanceArgs): Promise<CallToolResult> {
    const {
      developmentPhase,
      adrsToImplement = [],
      technologyStack = [],
...
- Validate recommendations align with domain best practices`,
  ...
  async getArchitecturalContext(args: GetArchitecturalContextArgs): Promise<CallToolResult> {
...
The enhanced process maintains full traceability from PRD requirements to generated ADRs while providing superior quality through advanced prompting techniques and ensuring security and user control over file operations.`,
  ...
  async compareAdrProgress(args: Record<string, unknown>): Promise<CallToolResult> {
    const {
      todoPath = 'TODO.md',
      adrDirectory = this.config.adrDirectory,
   ...
   */
  async detectAndValidateEnvironment(
    projectPath: string,
    environment: string,
   ...
   */
  async performLocalAdrProgressAnalysis(params: {
    todoContent: string;
    todoPath: string;
...
The AI agent will safely remove the specified cache entry.`,
  ...
  async configureOutputMasking(args: Record<string, unknown>): Promise<CallToolResult> {
...
`;
   ...
   */
  async suggestAdrs(args: Record<string, unknown>): Promise<CallToolResult> {
    const { suggestAdrs } = await import('./tools/adr-suggestion-tool.js');
    return await suggestAdrs(args);
  }

  async generateAdrFromDecision(args: GenerateAdrFromDecisionArgs): Promise<CallToolResult> {
    const { generateAdrFromDecision } = await import('./tools/adr-suggestion-tool.js');
    return await generateAdrFromDecision(args);
  }

  async generateAdrBootstrap(args: Record<string, unknown>): Promise<CallToolResult> {
  ...
  async bootstrapValidationLoop(args: Record<string, unknown>): Promise<CallToolResult> {
  ...
  async analyzeAdrTimeline(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async reviewExistingAdrs(args: Record<string, unknown>): Promise<CallToolResult> {
   ...
   */
  async validateAdr(args: Record<string, unknown>): Promise<CallToolResult> {
    const { validateAdr } = await import('./tools/adr-validation-tool.js');
    return await validateAdr(args as any);
  }

  async validateAllAdrs(args: Record<string, unknown>): Promise<CallToolResult> {
   ...
   */
  async incorporateResearch(args: Record<string, unknown>): Promise<CallToolResult> {
    const { incorporateResearch } = await import('./tools/research-integration-tool.js');
    return await incorporateResearch(args);
  }

  async createResearchTemplate(args: Record<string, unknown>): Promise<CallToolResult> {
    const { createResearchTemplate } = await import('./tools/research-integration-tool.js');
    return await createResearchTemplate(args);
  }

  async requestActionConfirmation(args: Record<string, unknown>): Promise<CallToolResult> {
   ...
   */
  async generateRules(args: Record<string, unknown>): Promise<CallToolResult> {
    const { generateRules } = await import('./tools/rule-generation-tool.js');
    return await generateRules(args);
  }

  async validateRules(args: ValidateRulesArgs): Promise<CallToolResult> {
    const { validateRules } = await import('./tools/rule-generation-tool.js');
    return await validateRules(args);
  }

  async createRuleSet(args: CreateRuleSetArgs): Promise<CallToolResult> {
   ...
   */
  async analyzeEnvironment(args: Record<string, unknown>): Promise<CallToolResult> {
    const { analyzeEnvironment } = await import('./tools/environment-analysis-tool.js');
   ...
   */
  async generateResearchQuestions(args: Record<string, unknown>): Promise<CallToolResult> {
   ...
   */
  async searchCodebase(args: Record<string, unknown>): Promise<CallToolResult> {
   ...
   */
  async analyzeDeploymentProgress(args: Record<string, unknown>): Promise<CallToolResult> {
  ...
  async applyOutputMasking(response: any): Promise<any> {
    try {
   ...
   */
  async enrichResponseWithStateReinforcement(
  ...
  async smartGitPush(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async deploymentReadiness(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async releaseTracking(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async generateAdrTodo(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async troubleshootGuidedWorkflow(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async smartScore(_args: Record<string, unknown>): Promise<CallToolResult> {
...
**Migration:** Health scoring is now integrated into the knowledge graph and automatically calculated based on memory usage patterns.`,
  ...
  async mcpPlanning(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async memoryLoading(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async expandAnalysisSection(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
  ...
  async interactiveAdrPlanning(args: Record<string, unknown>): Promise<CallToolResult> {
    try {
   ...
   */
  async toolChainOrchestrator(args: ToolChainOrchestratorArgs): Promise<CallToolResult> {
    try {
   ...
   */
  async expandMemory(args: any): Promise<CallToolResult> {
    try {
   ...
   */
  async queryConversationHistory(args: any): Promise<CallToolResult> {
    try {
   ...
   */
  async getConversationSnapshot(args: any): Promise<CallToolResult> {
    try {
   ...
   */
  async getMemoryStats(): Promise<CallToolResult> {
    try {
   ...
   */
  async updateKnowledge(args: any): Promise<CallToolResult> {
    try {
   ...
   */
  async getServerContext(args: any): Promise<CallToolResult> {
    try {
...
`;
   ...
   */
  async setProjectPath(args: { path: string; validatePath?: boolean }): Promise<CallToolResult> {
